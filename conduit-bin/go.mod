module github.com/joeymckenzie/realworld-go-kit/conduit-bin
...
replace (
	github.com/joeymckenzie/realworld-go-kit/conduit-api => ../conduit-api
	github.com/joeymckenzie/realworld-go-kit/conduit-core => ../conduit-core
